                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('create.preference') }}" method="POST" onsubmit="vaciarcarro()"
                            ...
                            <div class="row g-3">
                                ...
                                <!-- Dirección -->
                                <div class="col-md-6">
                                    <label for="direccion" class="form-label">Dirección/Barrio</label>
                    ...
                    <div class="card-body">
                        @foreach ($productos as $index => $producto)
                            <div class="row product-group align-items-center mb-3" id="product-{{ $index }}">
                                ...
                                <div class="col-3">
                                    <small class="d-block">
                                        Disponibles {!! $producto->stock > 0 ? $producto->stock : '<small class="text-danger">Se agotó</small>' !!}
                        ...
                        <div class="text-center mt-4">
                            ...
                            <button type="submit" class="myCar form-control">Procesar pago</button>
