...
<script>
    ...
    const mp = new MercadoPago('APP_USR-96d1a85d-0771-4302-9d36-d5ffc36c2e06', {locale: "co-CO" });
    

    document.getElementById('checkout-btn').addEventListener('click', function() {
        const cantidad = parseInt(document.getElementById('quantity').value, 10);
        const nombre = 'ivan samboni'
        ...
        const orderData = {
            ...
            name: nombre,
            surname: 'samboni', // Si tienes un campo de apellido, añádelo aquí
            email: 'samboni@hotmail.com', // Agrega el correo electrónico si es necesario
            phone: telefono,
            address: direccion,
        };
      ...
      const req =  fetch('/create-preference', {
                method: 'POST',
                headers: {
